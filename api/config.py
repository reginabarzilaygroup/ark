...
class MammoCancerMirai(Config):
    ...
    ONCONET_CONFIG = {
        ...
        'additional': None,
        'img_encoder_snapshot': 'models/snapshots/mgh_mammo_MIRAI_Base_May20_2019.p',
        'transformer_snapshot': 'models/snapshots/mgh_mammo_cancer_MIRAI_Transformer_Jan13_2020.p',
        'video': False,
